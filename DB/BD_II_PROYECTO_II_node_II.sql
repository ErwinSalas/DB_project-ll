...
INSERT INTO servicios(idServicio, nombre, idSede, costo, img) values(3, 'Canopy', 2, 25000, (SELECT bytea_import('C:\Users\CHRISTIAN\Documents\TEC\2018 I SEM\BASES DE DATOS II\postgresql.png')));
INSERT INTO servicios(idServicio, nombre, idSede, costo, img) values(4, 'Bungee', 2, 25000, (SELECT bytea_import('C:\Users\CHRISTIAN\Documents\TEC\2018 I SEM\BASES DE DATOS II\postgresql.png')));
INSERT INTO servicios(idServicio, nombre, idSede, costo, img) values(5, 'Caminata', 2, 10000, (SELECT bytea_import('C:\Users\CHRISTIAN\Documents\TEC\2018 I SEM\BASES DE DATOS II\postgresql.png')));

----------------------------------USERS FOR nodeI (idSede: 2)-------------------------------------

select newUser(1, 'xxx@xxx.com','123a','CHRISTIAN','SANCHEZ','SALAS');
select newUser(2, 'xxx@xxx.com','123b','USR2','A1','A2');
select newUser(3, 'xxx@xxx.com','123c','USR3','A1','A2');
select newUser(4, 'xxx@xxx.com','123d','USR4','A1','A2');
select newUser(5, 'xxx@xxx.com','123e','USR5','A1','A2');
